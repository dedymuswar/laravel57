    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::open (['action' => ['UserController@update',$users->id], 'method' => 'POST', 'enctype' =>'form-data'])!!}
                        @csrf
                        ...
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">{{ __('Level Admin') }}</label>
                            <div class="col-md-6">
                                {{ form::select('role',$roles, $roll, ['class' => 'form-control'])}}
                            </div>
                        </div>
